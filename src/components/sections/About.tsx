    ...
    <section id="about" className="relative w-full py-32 border-t border-white/5">
      ...
      >
        <motion.h2 
          ...
          className="text-sm font-semibold tracking-widest text-[#C1FF72] uppercase mb-8"
        >
          About Me
        </motion.h2>
        ...
        <motion.div 
          ...
          className="bg-[#141416] border border-white/[0.08] rounded-3xl p-8 md:p-12 shadow-2xl relative group overflow-hidden"
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 text-lg text-neutral-400 leading-relaxed relative z-10">
            <div>
              <p className="mb-6 text-white font-medium text-xl md:text-2xl tracking-tight leading-tight">
